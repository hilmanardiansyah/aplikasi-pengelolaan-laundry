    ...
    <div class="wrapper">
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <img src="../assets/img/laundry.png" alt="navbar brand" class="navbar-brand"style="width: 50px; height: auto;"style="display: flex; justify-content: center; align-items: center;">
                </a>
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="../assets/img/kasirmerah.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="../assets/img/kasirmerah.jpg" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
